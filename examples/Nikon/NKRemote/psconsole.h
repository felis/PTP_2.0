...
protected:
    ...
    static QState ChangeCompressionMenu(PSConsole *me, QEvent const *e);
    static QState ChangeFocusModeMenu(PSConsole *me, QEvent const *e);
    static QState ChangeFocusAreaMenu(PSConsole *me, QEvent const *e);
};
